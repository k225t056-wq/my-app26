# ゲーム自己紹介カードジェネレーター 利用マニュアル

このアプリは、簡単・綺麗・高画質にゲームの自己紹介カードを作成できるWebツールです。
...
- **メインゲーム**: 今ハマっているゲーム名を入力します。
- **プレイ歴 / プラットフォーム**: あなたのプレイスタイルに合わせて選択・入力してください。
...
## ⚠️ 注意事項
- このアプリはブラウザ内ですべての処理を行うため、アップロードした画像がサーバーに保存されることはありません。安心してご利用ください。
- ブラウザのシークレットモードや一部の拡張機能により、クリップボードへのコピーが制限される場合があります。その際は「ダウンロード」をご利用ください。
